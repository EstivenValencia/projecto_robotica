...
class Floor {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.tamaño, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.tamaño = _arrayDeserializer.float64(buffer, bufferOffset, null)
    return data;
  }
