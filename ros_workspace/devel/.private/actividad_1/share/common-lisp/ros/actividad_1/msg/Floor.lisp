...
(cl:defmethod cl:initialize-instance :after ((m <Floor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actividad_1-msg:<Floor> is deprecated: use actividad_1-msg:Floor instead.")))

(cl:ensure-generic-function 'pose_caja-val :lambda-list '(m))
(cl:defmethod pose_caja-val ((m <Floor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actividad_1-msg:pose_caja-val is deprecated.  Use actividad_1-msg:pose_caja instead.")
  (pose_caja m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Floor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actividad_1-msg:name-val is deprecated.  Use actividad_1-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'tamaño-val :lambda-list '(m))
(cl:defmethod tamaño-val ((m <Floor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actividad_1-msg:tamaño-val is deprecated.  Use actividad_1-msg:tamaño instead.")
  (tamaño m))
