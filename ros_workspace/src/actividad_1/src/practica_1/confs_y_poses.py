...
with open("src/actividad_1/src/practica_1/confs_y_poses/configuraciones.yaml", "w") as f:
...
with open("src/actividad_1/src/practica_1/confs_y_poses/poses.yaml", "w") as f:
